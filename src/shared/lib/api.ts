...
const USERS_API_URL = import.meta.env.VITE_USER_SERVICE_URL || 'http://localhost:3000';
...
export const api = new ApiClient(AUTH_API_URL);
export const userApi = new ApiClient(USERS_API_URL);
