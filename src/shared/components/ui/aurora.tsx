...
void mainImage( out vec4 fragColor, in vec2 fragCoord )
{
    ...
    // Create aurora color palette (warm terracotta + mint accent)
    vec3 color1 = vec3(0.98, 0.88, 0.82); // Crema calida
    vec3 color2 = vec3(0.78, 0.49, 0.40); // Terracota principal #C87C65
    vec3 color3 = vec3(0.50, 0.78, 0.66); // Verde menta #7FC7A9
    vec3 color4 = vec3(1.0,  0.94, 0.90); // Durazno muy claro
    ...
    // Blend aurora over white background
    vec3 bgColor = vec3(1.0, 1.0, 1.0);
    finalColor = mix(bgColor, finalColor, combinedAurora * u_intensity * 0.6);
