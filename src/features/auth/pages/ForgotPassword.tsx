import { ChevronLeft, Mail, RotateCcw, ShieldCheck } from "lucide-react";
                ...
                <CardContent className="space-y-6 pt-2">
                  <form onSubmit={handleSummit}>
                    <div className="space-y-2 pb-4">
                      ...
                      <p className="text-xs leading-5 text-[color:hsl(var(--peerly-text-secondary))] pt-2 pb-1">
                        Revisa tambien spam o promociones si el mensaje tarda unos minutos en llegar.
                      </p>
                    </div>
              ...
              <Card className="rounded-3xl border-border/60 bg-white/95 shadow-card w-full max-w-md">
                ...
                <CardContent className="space-y-6 pt-2">
                  <div className="space-y-2 pb-2">
                    <p className="font-medium text-[color:hsl(var(--peerly-primary-dark))]">Proximos pasos</p>
                    <p className="mt-2">1. Revisa tu bandeja principal, spam y promociones.</p>
                    <p> 2. Usa el enlace apenas llegue; puede expirar.</p>
                    <p> 3. Si no llega, intenta nuevamente con otro correo.</p>
                  </div>
                  <div className="space-y-3">
                    <Button
                      asChild
                      className="h-11 w-full rounded-2xl  text-sm font-display font-semibold text-white hover:bg-[hsl(var(--peerly-primary))]/90"
                    >
                      <Link
                        to="/forgot-password"
                        onClick={(e) => {
                        ...
                        Usar otro correo</Link>
                    </Button>
                  </div>
                  <p className="text-center text-xs leading-5 text-[color:hsl(var(--peerly-text-secondary))]">
                    Si no recibes nada en unos minutos, verifica que el correo escrito sea correcto antes de reenviar.
                  </p>
